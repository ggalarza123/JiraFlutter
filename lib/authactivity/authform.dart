...
class AuthFormState extends State<AuthForm> {
  ...
  Future addUserDetails(String email, String username, String role) async {
    ...
    //.doc(time.toString()) I had this line of code before, but it was giving me an error in identifyuser.dart
    // because user were now being created with doc id time, instead of autogenerated
        .doc()
        .set({
      'email': email,
      'username': username,
